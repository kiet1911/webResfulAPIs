...
namespace webResfulAPIs.Migrations
{
    ...
    [Migration("20260622125328_updateOrderaddurlandmerchantcode")]
    partial class updateOrderaddurlandmerchantcode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("webResfulAPIs.Models.BoardGames", b =>
                {
                    ...
                    b.Property<int>("Reservation_Quantity")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0)
            ...
            modelBuilder.Entity("webResfulAPIs.Models.CartItems", b =>
                {
            ...
            modelBuilder.Entity("webResfulAPIs.Models.Carts", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("BIGINT")
            ...
            modelBuilder.Entity("webResfulAPIs.Models.Favorites", b =>
                {
                    b.Property<Guid>("BoardGame_Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("boardgame_id");
            ...
            modelBuilder.Entity("webResfulAPIs.Models.OrderItems", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("webResfulAPIs.Models.Orders", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<bool>("IsSuccessDelivery")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("BIT")
                        .HasDefaultValue(false)
                        .HasColumnName("isSuccess_delivery");

                    b.Property<string>("MerchantRefNo")
                        .IsRequired()
                        .HasColumnType("nvarchar(100)")
                        .HasColumnName("merchant_refno");

                    b.Property<string>("NameRecipient")
                        .IsRequired()
                        .HasColumnType("nvarchar(100)")
                        .HasColumnName("name_reciptient");
            ...
            modelBuilder.Entity("webResfulAPIs.Models.CartItems", b =>
                {
                    ...
                    b.HasOne("webResfulAPIs.Models.Carts", "Cart")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("webResfulAPIs.Models.Carts", b =>
                {
                    b.HasOne("webResfulAPIs.Models.Users", "User")
                        .WithOne()
                        .HasForeignKey("webResfulAPIs.Models.Carts", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("webResfulAPIs.Models.OrderItems", b =>
                {
                    ...
                    b.HasOne("webResfulAPIs.Models.Orders", "Order")
                        .WithMany("OrderItems")
